...
4. **Generate Relationship Diagrams**
   - **ALWAYS use ASCII diagrams** (NOT mermaid, PlantUML, or other formats)
   - ASCII art provides better readability and universal compatibility
   - Entity relationship diagrams in ASCII
   - State machine diagrams in ASCII
   - Flow diagrams in ASCII box-drawing characters
